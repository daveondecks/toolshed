...
# Center section with PDCA cycle icon (now vertically centered)
with col2:
    st.markdown("<div style='text-align: center; margin-top: 100px; font-size: 50px;'>🔄</div>", unsafe_allow_html=True)
